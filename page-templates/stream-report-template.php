                      ...
                      <div class="panel-heading accordion-toggle collapsed" role="tab" id="headingTwentyone" data-toggle="collapse" data-parent="#accordion-private" href="#collapseTwentyone" aria-expanded="true" aria-controls="collapseTwentyone">
                        <div class="row">
                          ...
                          <div class="col-sm-6">
                            ...
                            <!-- === BEGIN EDIT SECTION: REPLACE 'label-default' with 'label-danger' to select any given rating === -->
                            <?php $hatcreekranch_closed_checkbox = get_post_meta(get_the_ID(), 'hatcreekranch-closed-checkbox', true);
                            if(get_post_meta(get_the_ID(), 'hatcreekranch-closed-checkbox', true) == '-danger'):?>
                              <span class="label label-default<?php echo $hatcreekranch_closed_checkbox;?>"><?php echo $hatcreekranch_closed_message; ?></span>
                            <?php else: ?>
                              <span class="label label-default<?php echo $hatcreekranch_checkbox_poor; ?>">Poor</span>
                              <span class="label label-default<?php echo $hatcreekranch_checkbox_fair; ?>">Fair</span>
                              <span class="label label-default<?php echo $hatcreekranch_checkbox_fairgood; ?>">Fair to Good</span>
                              <span class="label label-default<?php echo $hatcreekranch_checkbox_good; ?>">Good</span>
                              <span class="label label-default<?php echo $hatcreekranch_checkbox_great; ?>">Great</span>
                            <?php endif; ?>
